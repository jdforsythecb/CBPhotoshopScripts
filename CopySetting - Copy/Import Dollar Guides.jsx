...
// imports all guides from /g/jdforsythe/Settings/Photoshop Actions/PNG_Dollar_guides.txt
...
if (documents.length == 0) {
    ...
    fileOut = new File("/g/jdforsythe/Settings/Photoshop Actions/PNG_Dollar_guides.txt")

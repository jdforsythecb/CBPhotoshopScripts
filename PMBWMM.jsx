...
CB.swissKnife.movePMBWOnFontTools = function() {
...
CB.swissKnife.movePMBWOnDollarProof = function() {
    // x=-40px y=60px
...
if (CB.needProof) {
    ...
    CB.swissKnife.movePMBWOnDollarProof();
...
CB.swissKnife.movePMBWOnFontTools();
